...
<body>
    <section class="about" id="about" style="min-width : 870px">
        ...
        <div class="container">
            ...
            <br>
            <div class="col-sm-6">
                <a class="btn btn-warning btn-md text-white" href="registrasi.php" role="button" style="margin-left: -15px;">Daftar Sekarang</a>
            </div>
            ...
            <div class="row ">
                <div class="col-sm-6">
                    ...
                    <img style="max-width: 380px" src="images/1.login.png">
                </div>
                <div class="col-sm-6">
