...
$stocks = query("SELECT * FROM stocks ORDER BY title");
        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="adminchangepass.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    ...
                    <?php if (isset($error)) : ?>
                        <p style="color: red;"><br>Old Password Doesn't Match</p>
                    <?php endif; ?>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="newpassword" id="newpassword" class="form-control" placeholder="" required autocomplete="off">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="newpassword2">Confirm New Password </label>
                            <input type="password" name="newpassword2" id="newpassword2" class="form-control" placeholder="" required autocomplete="off">
                        </div>
                        <br>
